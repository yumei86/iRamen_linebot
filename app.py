...
#----------------選完湯頭介面/湯頭看更多類似推薦-----------------
    ...
    #各縣市湯頭清單
    #北部
    taipei = ["豚骨", "醬油", "雞白", "魚介", "沾麵", "雞清", "家系", "雞豚", "咖哩", "味噌", "柑橘", "淡麗系", "煮干", "素食", "魚白", "辣味", "拌麵"]
    ...
    #中部
    taichung = ["豚骨", "醬油", "雞白", "魚介", "沾麵", "雞清", "家系", "雞豚", "味噌", "辣味", "拌麵", "牛肉"]
    chuanghua = ["豚骨", "雞白", "家系"]
    nantou = ["豚骨"]
    yunlin = ["豚骨", "雞白", "魚介"]
    ...
    #南部
    chiayi = ["豚骨", "沾麵", "家系"]
    tainan = ["豚骨", "雞白", "魚介", "沾麵", "雞清", "雞豚", "咖哩", "淡麗系", "煮干", "素食", "拌麵", "辛口"]
    kaohsiung = ["豚骨", "醬油", "雞白", "魚介", "沾麵", "雞清", "家系", "雞豚", "淡麗系", "素食", "拌麵"]
